...
function IntroPage() {
  ...
  return (
    <div className="mt-15 md:mt-0 p-3">
      <div
      // className="flex w-full h-[80vh] flex-col-reverse md:flex-row relative"
      >
        {/* Text Section */}
        ...
        <div className="flex">
          <div className="mx-auto py-auto w-full md:w-full md:h-[30rem] relative ">
            <img
              src="Images/luxbenz.jpg"
              alt="Intro Image"
